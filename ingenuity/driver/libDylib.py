...
g_strLibNanohippoPath = '/Users/admin/PycharmProjects/Repository/MAC-FCT-LIB/ingenuity/driver/Lib/libAll.dylib'
...
if 'darwin' in str(platform.system()).lower():
    libPy = ctypes.CDLL(g_strLibNanohippoPath)
elif 'windows' in str(platform.system()).lower():
    libPy = ctypes.WinDLL('excapp.dll')
elif 'linux' in str(platform.system()).lower():
    libPy = ctypes.CDLL("libexcapp.so")
...
g_strLibGh = '/Users/admin/PycharmProjects/Repository/MAC-FCT-LIB/ingenuity/driver/Lib/libGhInfo.dylib'
...
g_strLibArmDl = '/Users/admin/PycharmProjects/Repository/MAC-FCT-LIB/ingenuity/driver/Lib/libArmDL.dylib'
...
libDl.updateConfig.argtypes = [ctypes.c_void_p, ctypes.c_int, ctypes.c_float, ctypes.c_float, ctypes.c_float,
...
g_strLibPSDl = '/Users/admin/PycharmProjects/Repository/MAC-FCT-LIB/ingenuity/driver/Lib/libPwrSequence.dylib'
